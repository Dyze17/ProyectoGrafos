...
@app.callback(
    ...
    [Input("add-node-button", "n_clicks"), Input("add-edge-button", "n_clicks"), Input('cytoscape', 'tapNode'), Input("undo-button", "n_clicks")],
...
def update_elements(node_clicks, edge_clicks, tap_node, undo_clicks, elements, node_id, node_label, edge_source, edge_target):
    ctx = callback_context
